<%-- 
    Document   : verHabitacion
    Created on : 05-ago-2021, 17:14:34
    Author     : Usuario
--%>
						...
						<table>
							<thead>
								<tr class="row100 head">
									<th class="cell100 column1">Temática</th>
								</tr>
							</thead>
							<tbody>
                                                            ...
                                                            <tr class="row100 body">
                                                                <% String tematica = habitacion.getTematica();%>
                                                                <td class="cell100 column2"><%=tematica%></td>
								</tr>
							</tbody>
                                                        <%}%>
						</table>
					...
					<div class="wrap-table100-nextcols js-pscroll">
						<div class="table100-nextcols">
							<table>
								<thead>
									<tr class="row100 head">
										<th class="cell100 column3" >Tipo de habitación</th>
										<th class="cell100 column4">Piso</th>
									...
									<% for(Habitacion habitacion : listaHabitacion){ %>
                                                                        <tr class="row100 body">
                                                                        <%String tipo = habitacion.getTipoHabitacion();%>
                                                                        <td class="cell100 column3"><%=tipo%></td>  
                                                                        <%int piso = habitacion.getPiso_habitacion();%>
                                                                        <td class="cell100 column4"><%=piso%></td> 
                                                                        
                                                                        <%long id = habitacion.getId_habitacion();%>
                                                                        <td class="cell100 column6">
                                                                        <form name="id" action="SvEliminarHabitacion" method="POST" style="">
                                                                        ...
                                                                        <td class="cell100 column9">
                                                                            ...
                                                                            <form name="id" action="SvEditarHabitacion" method="POST" style="">
                                                                                <input type="hidden" name="id" value="<%=id%>">
