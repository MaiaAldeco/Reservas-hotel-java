                            ...
                            <table>
                                ...
                                <thead>
                                    ...
                                    <tr class="row100 head">
                                        <th class="cell100 column1">Día realizada:</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    ...
                                    <%  HttpSession sesion = request.getSession();
                                        ...
                                        if (listaReservas != null) {
                                            for (Reserva reserva : listaReservas) {
                                                ...
                                                String realizacion = formato.format(reserva.getDiaRealizacion());
                                                reserva.getTotal();
                                    %> 
                                    ...
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column2"><%=realizacion%></td>
                                    </tr>
                                </tbody>
                                <%}%>
                                <%}%>
                            ...
                            <div class="table100-nextcols">
                                <table>
                                    ...
                                    <tr class="row100 body">
                                        ...
                                        <td class="cell100 column5"><%=reserva.getEmpleado().getNombre()%></td> 
